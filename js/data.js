export const questions = [
  {
    ...
    choices: [
      { text: '파티 스텝은 못하지ㅎ...<br>(파티...?도 안가도 되나...)', value: 'i' },
      { text: '재밌겠다!<br>소연이한테 같이 지원하자고 해야지~', value: 'e' }
    ]
  },
  {
    number: '02',
    ...
    choices: [
      { text: '짐 다 챙겼으니까 일찍 자야지~', value: 's' },
      { text: '다 챙겼겠지?<br>옷을 좀 더 챙길까..(뒤적뒤적)', value: 'n' }
    ]
  },
  {
    number: '03',
    ...
    choices: [
      { text: '일이 많이 힘들었나?<br>내가 좀 더 챙겨줄걸.', value: 'f' },
      { text: '이직하나?<br>퇴사하고 뭐하냐고 물어봐야지.', value: 't' }
    ]
  },
  {
    number: '04',
    ...
    choices: [
      ...
      { text: '일단 시작해보자!<br>미팅 먼저 잡고 팀원이랑 이야기하면 되겠지?', value: 'p' }
    ]
  },
  {
    number: '05',
    ...
    choices: [
      { text: '안녕하세요ㅎㅎ 잘 부탁드려요~<br>(아... 집에 가고 싶다.)', value: '' },
  ...
  },
  {
    ...
    choices: [
      { text: '드디어 회사가 날 알아주는구나!<br>더 열심히 하자!', value: '' },
      { text: '진급하면 월급도 오르겠지?<br>월급 오르면 뭐부터 사야하지~', value: '' }
    ]
  },
]
